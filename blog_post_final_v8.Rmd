...
* These findings suggest that hockey management and coaches must not read too much into the (lack of) offensive opportunities during odd player rushes in the first half; the second half presents a new playing field for players when it comes to odd player rushes.
...
* This tells us that set plays are not going to yield consistent results. 
* For example, a premeditated faceoff play, which involves a primary pass from the same lane everytime, is not going to yield the same proportion of goals from the first half to the second half.
