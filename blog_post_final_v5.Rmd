...
* A team's rate of rush shots is not repeatable within seasons

* A team's rate of shots in other situations is repeatable within seasons.

* Shooting percentages across the whole season are significantly higher in rushes with odd player rushes.

* Shooting percentages during odd player rushes and other situations are not repeatable within seasons.

* The lane of a primary pass does not help explain the discrepancy in repeatability of shooting percentages in odd player rushes.

* Rebound shots are not repeatable over a given season. However, rebound shooting percentages (rebound goals (goals that follow rebounds) divided by rebound shots) are repeatable.
...
pass_odd_man %>%
  ...
  geom_point(aes(color = season), size = 10) +
...
pass_shooting_percentage <- pass_final %>% 
  ...
  summarise(sum_shot_on_goal = n(),
            shooting_percentage = 100 * (sum(goal) / n())) %>% 
...
Hockey literature reveals that "goalies generally do not have an ability to control rebounds" [(Pettapiece, 2018)](https://www.nhlnumbers.com/2013/7/15/can-goalies-control-the-number-of-rebounds-they-allow). This accounts for the unpredictability of rebounds over a season.
